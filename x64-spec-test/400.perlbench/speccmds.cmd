...
-E https_proxy http://127.0.0.1:40333/
-E no_proxy localhost,127.0.0.0/8,::1
-C /home/zhe/Workspace/SPEC06_src/benchspec/CPU2006/400.perlbench/run/run_base_test_x64.0000
-o attrs.out -e attrs.err ../run_base_test_x64.0000/perlbench_base.x64 -I. -I./lib attrs.pl
-o gv.out -e gv.err ../run_base_test_x64.0000/perlbench_base.x64 -I. -I./lib gv.pl
-o makerand.out -e makerand.err ../run_base_test_x64.0000/perlbench_base.x64 -I. -I./lib makerand.pl
-o pack.out -e pack.err ../run_base_test_x64.0000/perlbench_base.x64 -I. -I./lib pack.pl
-o redef.out -e redef.err ../run_base_test_x64.0000/perlbench_base.x64 -I. -I./lib redef.pl
-o ref.out -e ref.err ../run_base_test_x64.0000/perlbench_base.x64 -I. -I./lib ref.pl
-o regmesg.out -e regmesg.err ../run_base_test_x64.0000/perlbench_base.x64 -I. -I./lib regmesg.pl
-o test.out -e test.err ../run_base_test_x64.0000/perlbench_base.x64 -I. -I./lib test.pl
